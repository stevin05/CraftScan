...
function CraftScan.LOCAL_MX:GetData()
    ...
    return {
        ...
        ["dialog.GREETING_I_CAN_CRAFT_ITEM.tooltip.body"] = "El mensaje para enviar a los clientes cuando el personaje actual puede fabricar el ítem solicitado.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM"]    = "Mi alter, {crafter}, puede fabricar {item}.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM.tooltip.body"] = "El mensaje para enviar a los clientes cuando un alter puede fabricar el ítem solicitado.",
        ...
        ["dialog.item.keywords"]                  = "Palabras clave del ítem",
        ["dialog.item.keywords.tooltip.body"]     = "Una lista de palabras clave separadas por comas. La coincidencia de palabras clave se utiliza cuando una solicitud no incluye un enlace de ítem. Después de coincidir con una profesión específica, estas palabras clave se verifican para refinar la coincidencia a un ítem específico.",
        ["dialog.item.secondary_keywords"]        = "Palabras clave secundarias del ítem",
        ["dialog.item.secondary_keywords.tooltip.body"] = "Después de coincidir con una palabra clave anterior, se verifica un mensaje en busca de palabras clave secundarias para refinar la coincidencia, permitiendo diferenciar las diversas artesanías para la misma ranura de ítem. Se seleccionará el ítem con la mayor cantidad de coincidencias de palabras clave secundarias. Es una buena idea usar etiquetas de sustitución en palabras clave secundarias para que puedan cambiarse fácilmente globalmente de temporada en temporada a medida que cambian los niveles de los ítems.",
        ["dialog.item.commission"]                = "Comisión del ítem",
        ["dialog.item.commission.tooltip.body"]   = "Por ejemplo, '10000g', Predeterminado: 'Cualquiera'\nEste texto aparece en la tabla 'Encontrar Artesano' del cliente.",
        ["dialog.item.greeting"]                  = "Saludo del ítem",
        ["dialog.item.greeting.tooltip.body"]     = "Un saludo específico del ítem cuando este ítem ha coincidido. Esto se añade después del saludo general y de la profesión.",
        ["dialog.item.omit_general"]              = "Omitir saludo general",
        ["dialog.item.omit_general.tooltip.body"] = "Omitir el saludo general al saludar al cliente sobre este ítem.",
        ["dialog.item.omit_profession"]           = "Omitir saludo de profesión",
        ["dialog.item.omit_profession.tooltip.body"] = "Omitir el saludo de profesión al saludar al cliente sobre este ítem.",
        ...
        ["dialog.disable_scan_state.tooltip.body"] = "No escanear el chat en busca de este ítem.\n\nEste ítem se colocará en la sección 'Escaneo desactivado' y se puede habilitar nuevamente en cualquier momento.",
        ["dialog.enable_scan_state"]              = "Habilitar escaneo",
        ["dialog.enable_scan_state.tooltip.body"] = "Escanear el chat en busca de este ítem.\n\nUn mensaje con un enlace a este ítem activará una coincidencia.\n\nUna palabra clave de profesión seguida de una palabra clave de ítem también activará una coincidencia.\n\nEste ítem se colocará en la sección 'Escaneo activado' y se puede desactivar nuevamente en cualquier momento.",
        ...
        ["dialog.prof.keywords.tooltip.body"]     = "Una lista de palabras clave separadas por comas. La coincidencia de palabras clave se utiliza cuando una solicitud no incluye un enlace de ítem.\n\nSe debe encontrar un término de profesión en el mensaje antes de verificar cualquier palabra clave de ítem.\n\nEsto debe incluir cualquier cosa que un cliente pueda decir que indique una profesión específica, como 'placa' para Herrería.",
        ...
        ["dialog.prof.commission.tooltip.body"]   = "Por ejemplo, '10000g', Predeterminado: 'Cualquiera'\nEste texto aparece en la tabla 'Encontrar Artesano' del cliente.\n\nSi se especifica, la comisión específica del ítem anula este valor.",
        ["dialog.prof.greeting"]                  = "Saludo de profesión",
        ["dialog.prof.greeting.tooltip.body"]     = "Un saludo específico de la profesión que se incluirá después del saludo general y antes del saludo del ítem.\n\nEste saludo se puede omitir ítem por ítem a través de la opción 'Omitir saludo de profesión'.",
        ...
        ["dialog.tag.header.tooltip.body"]        = "Las etiquetas de sustitución se pueden usar en saludos y cuadros de palabras clave en toda la interfaz de usuario.\n\nCuando las etiquetas están en uso, la interfaz de usuario mostrará la etiqueta en sí al editar y el valor de reemplazo cuando no se esté editando.\n\nLas etiquetas están destinadas a apoyar la actualización de contenido estacional y evitar la duplicación.\n\nLas palabras clave para cada ítem se pueden configurar usando una etiqueta para la ranura del ítem. Por ejemplo, todos los brazales en todas las profesiones pueden compartir una etiqueta que se refiera a la misma lista de palabras similares a brazales.\n\nLas palabras clave secundarias a menudo incluyen niveles de ítems que cambian de temporada en temporada. Configúralas con las etiquetas predeterminadas {Epic}, {Blue} y {pvp} que se pueden completar con tabulador, y luego cada temporada, actualiza los niveles de los ítems en un solo lugar en todas las profesiones e ítems.\n\nEstablece la comisión en todos tus saludos a una etiqueta, y luego cobra de más a esos tontos cuando la competencia esté desconectada.",
        ...
        [LID.RN_CONFIG_REWORK + 1]                = "En preparación para Midnight y los constantes cambios de configuración requeridos al aprender nuevos árboles de profesión, la interfaz de usuario se ha actualizado para facilitar ver qué ítems tienen el escaneo habilitado.",
        ...
        [LID.RN_CONFIG_REWORK + 3]                = "El escaneo de ítems ahora tiene cuatro estados: pendiente de revisión, activado, desactivado y no aprendido. A medida que se aprenden las recetas, se mueven a pendiente de revisión, lo que facilita el seguimiento de lo que podrías querer habilitar.",
        [LID.RN_CONFIG_REWORK + 4]                = "Se puede acceder a este nuevo panel a través del botón 'Config' en la parte superior de 'Órdenes de Chat', o el botón habitual 'Mostrar CraftScan' en la ventana de profesión.",
        ...
        [LID.RN_SUBSTITUTION_TAGS + 3]            = "Los niveles de ítems estacionales a menudo se incluyen en palabras clave secundarias. Las palabras clave secundarias ahora se completan con tabulador a etiquetas 'Epic', 'Rare' y 'pvp', que se pueden usar para establecer niveles de ítems en un solo lugar para actualizaciones fáciles.",
        [LID.RN_SUBSTITUTION_TAGS + 4]            = "La abreviatura común para ítems a menudo se incluye en palabras clave de ítems. Estas ahora se pueden compartir entre profesiones y rarezas para que solo necesites configurar cada ranura una vez. Las palabras clave de ítems ahora se completan con tabulador a una etiqueta de ranura de ítem.",
