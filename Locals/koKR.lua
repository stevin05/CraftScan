...
function CraftScan.LOCAL_KO:GetData()
    ...
    return {
        ...
        [LID.CONFIG_TOGGLE_BINDING_NAME]          = "설정 페이지 전환",
        ["Config"]                                = "설정",
        ["DELETED"]                               = "삭제됨",
        ["Crafters"]                              = "제작자",
        ["Legacy Crafters"]                       = "레거시 제작자",
        [LID.PENDING_REVIEW]                      = "검토 대기 중",
        [LID.SCANNING_ON]                         = "스캔 켜기",
        [LID.SCANNING_OFF]                        = "스캔 끄기",
        [LID.UNLEARNED]                           = "배우지 않음",
        ["General"]                               = "일반",
        ["Base Filters"]                          = "기본 필터",
        ["Customer Greetings"]                    = "고객 인사말",
        ["Unsaved Changes"]                       = "변경 사항이 저장되지 않았습니다.",
        ["dialog.inclusions"]                     = "필수 키워드",
        ["dialog.inclusions.tooltip.body"]        = "쉼표로 구분된 키워드 목록입니다. 이 키워드는 매칭의 첫 번째 단계입니다. 이 단어 중 하나를 포함하지 않는 메시지는 무시됩니다.",
        ["dialog.exclusions"]                     = "차단된 키워드",
        ["dialog.exclusions.tooltip.body"]        = "쉼표로 구분된 키워드 목록입니다. 이 키워드는 매칭의 첫 번째 단계입니다. 이 단어 중 하나를 포함하는 메시지는 무시됩니다.",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM"]      = "{item} 제작 가능합니다.",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM.tooltip.body"] = "현재 캐릭터가 요청된 아이템을 제작할 수 있을 때 고객에게 보낼 메시지입니다.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM"]    = "내 대체 캐릭터, {crafter}가 {item}를 제작할 수 있습니다.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM.tooltip.body"] = "대체 캐릭터가 요청된 아이템을 제작할 수 있을 때 고객에게 보낼 메시지입니다.",
        ["dialog.GREETING_I_HAVE_PROF"]           = "{profession}을 가지고 있습니다.",
        ["dialog.GREETING_I_HAVE_PROF.tooltip.body"] = "현재 캐릭터가 요청된 직업을 가지고 있을 때 고객에게 보낼 메시지입니다.",
        ["dialog.GREETING_ALT_HAS_PROF"]          = "내 대체 캐릭터, {crafter}가 {profession}을 가지고 있습니다.",
        ["dialog.GREETING_ALT_HAS_PROF.tooltip.body"] = "대체 캐릭터가 요청된 직업을 가지고 있을 때 고객에게 보낼 메시지입니다.",
        ["dialog.GREETING_ALT_SUFFIX"]            = "캐릭터를 변경하려면 알려주세요.",
        ["dialog.GREETING_ALT_SUFFIX.tooltip.body"] = "대체 캐릭터가 제작자일 때 인사말에 추가되는 문장입니다.",
        ["dialog.GREETING_BUSY"]                  = "지금 바쁩니다. 하지만 나중에 만들 수 있습니다.",
        ["dialog.GREETING_BUSY.tooltip.body"]     = "'바쁨 모드' 상자가 체크되었을 때 인사말에 추가되는 문장입니다. 이는 두 번째 계정과 함께 사용하여 게임을 플레이하는 동안 두 번째 계정이 마을에 앉아 주문을 대리하여 나중에 처리할 수 있도록 하기 위한 것입니다.\n\nMidnight의 애드온 변경으로 인해 이는 더 이상 유용하지 않을 수 있지만, 제작자가 드문 확장팩 초기에는 도움이 될 수 있습니다.",
        ["dialog.item.keywords"]                  = "아이템 키워드",
        ["dialog.item.keywords.tooltip.body"]     = "쉼표로 구분된 키워드 목록입니다. 키워드 매칭은 요청에 아이템 링크가 포함되지 않을 때 사용됩니다. 특정 직업과 일치한 후, 이 키워드를 확인하여 특정 아이템에 대한 일치를 구체화합니다.",
        ["dialog.item.secondary_keywords"]        = "보조 아이템 키워드",
        ["dialog.item.secondary_keywords.tooltip.body"] = "위의 키워드와 일치한 후, 메시지에서 보조 키워드를 확인하여 일치를 구체화하고 동일한 아이템 슬롯에 대한 다양한 제작을 구분할 수 있습니다. 가장 많은 보조 키워드 일치를 가진 아이템이 선택됩니다. 아이템 레벨이 변경됨에 따라 시즌마다 전역적으로 쉽게 변경할 수 있도록 보조 키워드에 대체 태그를 사용하는 것이 좋습니다.",
        ["dialog.item.commission"]                = "아이템 수수료",
        ["dialog.item.commission.tooltip.body"]   = "예: '10000g', 기본값: '아무거나'\n이 텍스트는 고객의 '제작자 찾기' 표에 나타납니다.",
        ["dialog.item.greeting"]                  = "아이템 인사말",
        ["dialog.item.greeting.tooltip.body"]     = "이 아이템이 일치했을 때의 아이템별 인사말입니다. 이는 일반 및 직업 인사말 뒤에 추가됩니다.",
        ["dialog.item.omit_general"]              = "일반 인사말 생략",
        ["dialog.item.omit_general.tooltip.body"] = "이 아이템에 대해 고객에게 인사할 때 일반 인사말을 생략합니다.",
        ["dialog.item.omit_profession"]           = "직업 인사말 생략",
        ["dialog.item.omit_profession.tooltip.body"] = "이 아이템에 대해 고객에게 인사할 때 직업 인사말을 생략합니다.",
        ["default.tag.value"]                     = "'대체 태그' 카테고리에서 이 태그를 구성하세요.",
        ["dialog.contains_substitution_tags.tooltip.title"] = "이 텍스트에는 대체 태그가 포함되어 있습니다.",
        ["dialog.contains_substitution_tags.tooltip.body"] = "태그는 표시될 때 확장되고 편집 중에는 축소됩니다.",
        ["dialog.disable_scan_state"]             = "스캔 비활성화",
        ["dialog.disable_scan_state.tooltip.body"] = "이 아이템에 대한 채팅 스캔을 하지 않습니다.\n\n이 아이템은 '스캔 끄기' 섹션에 배치되며 언제든지 다시 활성화할 수 있습니다.",
        ["dialog.enable_scan_state"]              = "스캔 활성화",
        ["dialog.enable_scan_state.tooltip.body"] = "이 아이템에 대한 채팅을 스캔합니다.\n\n이 아이템에 대한 링크가 포함된 메시지는 일치를 트리거합니다.\n\n직업 키워드 뒤에 아이템 키워드가 오면 일치도 트리거됩니다.\n\n이 아이템은 '스캔 켜기' 섹션에 배치되며 언제든지 다시 비활성화할 수 있습니다.",
        ["tag.invalid.braces"]                    = "태그에는 '{' 또는 '}'를 포함할 수 없습니다.",
        ["tag.invalid.unique"]                    = "태그는 고유해야 합니다.",
        ["tag.invalid.context"]                   = "이것은 내장된 문맥 감지 태그입니다. 인사말에서만 지원되며 고객 요청에 따른 세부 정보로 대체됩니다.",
        ["dialog.prof.keywords"]                  = "직업 키워드",
        ["dialog.prof.keywords.tooltip.body"]     = "쉼표로 구분된 키워드 목록입니다. 키워드 매칭은 요청에 아이템 링크가 포함되지 않을 때 사용됩니다.\n\n아이템 키워드를 확인하기 전에 메시지에서 직업 용어를 찾아야 합니다.\n\n여기에는 대장기술의 '판금'과 같이 특정 직업을 나타내는 고객이 말할 수 있는 모든 것이 포함되어야 합니다.",
        ["dialog.prof.exclusions"]                = "차단된 직업 키워드",
        ["dialog.prof.exclusions.tooltip.body"]   = "쉼표로 구분된 키워드 목록입니다. 직업과 일치하지만 이 키워드 중 하나를 포함하는 메시지는 직업 일치로 간주되지 않습니다.\n\n이 목록의 주요 사용 사례는 직업 도구입니다. 요청에는 종종 고객이 원하는 도구의 직업이 포함되지만, 그것을 만들 수 있는 직업은 포함되지 않습니다. 예를 들어, 'LF 연금 도구'는 연금술을 위한 도구를 만들어 줄 재봉사나 주문각인사를 찾고 있을 가능성이 높으므로 연금술과 일치시켜서는 안 됩니다.",
        ["dialog.prof.commission"]                = "직업 수수료",
        ["dialog.prof.commission.tooltip.body"]   = "예: '10000g', 기본값: '아무거나'\n이 텍스트는 고객의 '제작자 찾기' 표에 나타납니다.\n\n지정된 경우 아이템별 수수료가 이 값을 덮어씁니다.",
        ["dialog.prof.greeting"]                  = "직업 인사말",
        ["dialog.prof.greeting.tooltip.body"]     = "일반 인사말 뒤와 아이템 인사말 앞에 포함될 직업별 인사말입니다.\n\n이 인사말은 '직업 인사말 생략' 옵션을 통해 아이템별로 생략할 수 있습니다.",
        ["dialog.prof.omit_general"]              = "일반 인사말 생략",
        ["dialog.prof.omit_general.tooltip.body"] = "이 직업에 대해 고객에게 인사할 때 일반 인사말을 생략합니다.",
        ["dialog.tag.header.key"]                 = "태그",
        ["dialog.tag.header.value"]               = "대체 값",
        ["dialog.tag.header"]                     = "대체 태그",
        ["dialog.tag.header.tooltip.body"]        = "대체 태그는 UI 전체의 인사말 및 키워드 상자에서 사용할 수 있습니다.\n\n태그를 사용할 때 UI는 편집 시 태그 자체를 표시하고 편집하지 않을 때는 대체 값을 표시합니다.\n\n태그는 시즌 콘텐츠 업데이트 및 중복 방지를 지원하기 위한 것입니다.\n\n각 아이템의 키워드는 아이템 슬롯에 대한 태그를 사용하여 구성할 수 있습니다. 예를 들어, 모든 직업의 모든 손목보호구는 손목보호구와 유사한 단어 목록을 참조하는 태그를 공유할 수 있습니다.\n\n보조 키워드에는 종종 시즌마다 변경되는 아이템 레벨이 포함됩니다. 기본 탭 완성 가능한 {Epic}, {Blue} 및 {pvp} 태그로 구성한 다음 매 시즌 모든 직업 및 아이템에 대해 한곳에서 아이템 레벨을 업데이트하세요.\n\n모든 인사말의 수수료를 태그로 설정한 다음 경쟁자가 오프라인일 때 그들을 이용하세요.",
        ["dialog.tag.new"]                        = "새 태그 만들기",
        ["dialog.tag.new.tooltip.body"]           = "태그는 고유해야 하며 '{' 또는 '}'를 포함할 수 없습니다.",
        ["dialog.tag.new.button"]                 = "만들기",
        ["dialog.tag.copy"]                       = "{%s} 복사",
        ["dialog.tag.delete"]                     = "{%s} 삭제",
        ["dialog.tag.delete.help"]                = "태그를 삭제하려면 오른쪽 클릭",
        ["dialog.tag.autocomplete_enabled"]       = "자동 완성",
        ["dialog.tag.autocomplete_enabled.tooltip.body"] = "활성화되면 입력하는 동안 텍스트 입력이 태그를 자동 완성합니다.",
        [LID.RN_DISCORD]                          = "Discord",
        [LID.RN_DISCORD + 1]                      = "https://discord.gg/BCnAswxsSj",
        [LID.RN_DISCORD + 2]                      = "이 상자가 복사/붙여넣기를 지원하도록 요청하려면 다음으로 이동하세요:",
        [LID.RN_DISCORD + 3]                      = "https://github.com/stevin05/CraftScan",
        [LID.RN_CONFIG_REWORK]                    = "구성 재작업",
        [LID.RN_CONFIG_REWORK + 1]                = "Midnight 및 새로운 직업 트리를 배우는 동안 필요한 지속적인 구성 변경에 대비하여, 어떤 아이템이 스캔 활성화되어 있는지 더 쉽게 확인할 수 있도록 UI가 업데이트되었습니다.",
        [LID.RN_CONFIG_REWORK + 2]                = "직업 및 인사말 구성이 자체 패널로 이동되었습니다. 직업을 한 번 열면 모든 캐릭터가 새 메뉴에서 구성할 수 있습니다.",
        [LID.RN_CONFIG_REWORK + 3]                = "아이템 스캔에는 이제 검토 대기 중, 켜짐, 꺼짐, 배우지 않음의 네 가지 상태가 있습니다. 레시피를 배우면 검토 대기 중으로 이동하여 활성화하려는 항목을 쉽게 추적할 수 있습니다.",
        [LID.RN_CONFIG_REWORK + 4]                = "이 새 패널은 '채팅 주문' 상단의 '설정' 버튼이나 직업 창의 일반적인 'CraftScan 표시' 버튼을 통해 액세스할 수 있습니다.",
        [LID.RN_SUBSTITUTION_TAGS]                = "대체 태그",
        [LID.RN_SUBSTITUTION_TAGS + 1]            = "대체 태그는 이제 UI 전체의 인사말 및 키워드에서 사용할 수 있습니다.",
        [LID.RN_SUBSTITUTION_TAGS + 2]            = "태그는 시즌 콘텐츠를 빠르게 업데이트하고 중복을 방지하기 위한 것입니다.",
        [LID.RN_SUBSTITUTION_TAGS + 3]            = "시즌 아이템 레벨은 종종 보조 키워드에 포함됩니다. 보조 키워드는 이제 'Epic', 'Rare' 및 'pvp' 태그로 탭 완성되며, 이를 사용하여 쉬운 업데이트를 위해 한곳에서 아이템 레벨을 설정할 수 있습니다.",
        [LID.RN_SUBSTITUTION_TAGS + 4]            = "아이템에 대한 일반적인 약어는 종종 아이템 키워드에 포함됩니다. 이제 직업 및 희귀도 전반에 걸쳐 공유할 수 있으므로 각 슬롯을 한 번만 설정하면 됩니다. 아이템 키워드는 이제 아이템 슬롯 태그로 탭 완성됩니다.",
        [LID.RN_SUBSTITUTION_TAGS + 5]            = "인사말도 태그를 지원하므로 경쟁자가 로그인 및 로그아웃할 때 수수료를 쉽게 분류하고 업데이트할 수 있습니다.",
        [LID.RN_SUBSTITUTION_TAGS + 6]            = "태그 도입으로 내장된 직업 카테고리에 기반한 구성 지원이 제거되었습니다. 이제 대신 태그를 통해 자신만의 그룹을 만들 수 있습니다.",
        [LID.RN_SUBSTITUTION_TAGS + 7]            = "태그는 매우 기본적인 자동 완성 시스템을 지원합니다. 입력하는 동안 선택 항목이 팝업되며 가능한 선택 항목이 하나만 있으면 태그를 완료합니다. 너무 성가시다면 비활성화할 수 있습니다.",
        ["Concentration Dependent"]               = "집중 의존",
        ["dialog.item.required_concentration"]    = "필요한 집중",
        ["dialog.item.required_concentration.tooltip.body"] = "사용 가능한 집중을 기반으로 이 아이템을 조건부로 스캔합니다.\n\n필요한 집중의 정확한 양은 직업 트리와 제공된 재료에 따라 다릅니다. CraftSim의 시뮬레이션 모드를 사용하여 좋은 추정치를 얻으세요.\n\n0이 아닌 값으로 설정하면 이 레시피는 스캔이 집중에 의존함을 나타내는 별도 섹션에 배치됩니다.",
        ["dialog.item.required_concentration.tooltip.body.ready"] = "현재 집중: %d.\n\n스캔 켜짐.",
        ["dialog.item.required_concentration.tooltip.body.cooldown"] = "현재 집중: %d.\n\n스캔은 %s 후에 활성화됩니다.",
        ["dialog.pending_review_state"]           = "검토 대기 중",
        ["dialog.pending_review_state.tooltip.body"] = "이 레시피를 검토 대기 중 섹션으로 다시 이동합니다.\n\n검토 대기 중은 준비 영역으로 의도되어 최대 등급으로 제작할 수 있는 지식이 충분해지면 활성화하려는 레시피를 쉽게 추적할 수 있습니다.",
        ["Open in CraftScan"]                     = "CraftScan 연결",
        ["dialog.enable_all"]                     = "모두 활성화",
        ["dialog.enable_all.tooltip.body"]        = "현재 검토 대기 중인 모든 레시피에 대해 스캔을 활성화합니다. 배우지 않은 레시피는 배웠을 때 자동으로 활성화되지 않습니다.",
        ["Not supported"]                         = "스캔 불가",
        ["decor"]                                 = "장식",
        ["Loading..."]                            = "로딩 중...",
        ["Hide CraftScan"]                        = "CraftScan 분리",
    }
end
