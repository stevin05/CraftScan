...
function CraftScan.LOCAL_DE:GetData()
    ...
    return {
        ...
        [LID.CONFIG_TOGGLE_BINDING_NAME]          = "Konfigurationsseite umschalten",
        ["Config"]                                = "Konfig",
        ["DELETED"]                               = "GELÖSCHT",
        ["Crafters"]                              = "Handwerker",
        ["Legacy Crafters"]                       = "Alte Handwerker",
        [LID.PENDING_REVIEW]                      = "Ausstehende Überprüfung",
        [LID.SCANNING_ON]                         = "Scannen Ein",
        [LID.SCANNING_OFF]                        = "Scannen Aus",
        [LID.UNLEARNED]                           = "Nicht gelernt",
        ["General"]                               = "Allgemein",
        ["Base Filters"]                          = "Basisfilter",
        ["Customer Greetings"]                    = "Kundenbegrüßungen",
        ["Unsaved Changes"]                       = "Deine Änderungen wurden nicht gespeichert.",
        ["dialog.inclusions"]                     = "Erforderliche Schlüsselwörter",
        ["dialog.inclusions.tooltip.body"]        = "Eine kommagetrennte Liste von Schlüsselwörtern. Diese Schlüsselwörter sind die erste Ebene der Übereinstimmung. Jede Nachricht, die keines dieser Wörter enthält, wird ignoriert.",
        ["dialog.exclusions"]                     = "Schwarze Liste Schlüsselwörter",
        ["dialog.exclusions.tooltip.body"]        = "Eine kommagetrennte Liste von Schlüsselwörtern. Diese Schlüsselwörter sind die erste Ebene der Übereinstimmung. Jede Nachricht, die eines dieser Wörter enthält, wird ignoriert.",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM"]      = "Ich kann {item} herstellen.",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM.tooltip.body"] = "Die Nachricht, die an Kunden gesendet wird, wenn der aktuelle Charakter den angeforderten Gegenstand herstellen kann.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM"]    = "Mein Twink, {crafter}, kann {item} herstellen.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM.tooltip.body"] = "Die Nachricht, die an Kunden gesendet wird, wenn ein Twink den angeforderten Gegenstand herstellen kann.",
        ["dialog.GREETING_I_HAVE_PROF"]           = "Ich habe {profession}.",
        ["dialog.GREETING_I_HAVE_PROF.tooltip.body"] = "Die Nachricht, die an Kunden gesendet wird, wenn der aktuelle Charakter den angeforderten Beruf hat.",
        ["dialog.GREETING_ALT_HAS_PROF"]          = "Mein Twink, {crafter}, hat {profession}.",
        ["dialog.GREETING_ALT_HAS_PROF.tooltip.body"] = "Die Nachricht, die an Kunden gesendet wird, wenn ein Twink den angeforderten Beruf hat.",
        ["dialog.GREETING_ALT_SUFFIX"]            = "Sag Bescheid, um Charaktere zu wechseln.",
        ["dialog.GREETING_ALT_SUFFIX.tooltip.body"] = "Ein zusätzlicher Satz, der an die Begrüßung angehängt wird, wenn ein Twink der Handwerker ist.",
        ["dialog.GREETING_BUSY"]                  = "Ich bin gerade beschäftigt, kann das aber später herstellen.",
        ["dialog.GREETING_BUSY.tooltip.body"]     = "Ein zusätzlicher Satz, der an die Begrüßung angehängt wird, wenn das Kästchen 'Beschäftigt-Modus' aktiviert ist. Dies ist für die Verwendung in Kombination mit einem zweiten Account gedacht, damit du das Spiel spielen kannst, während der zweite Account in der Stadt sitzt und Aufträge an dich weiterleitet, um sie später zu erledigen.\n\nMit den Addon-Änderungen in Midnight ist dies wahrscheinlich nicht mehr sehr nützlich, könnte aber zu Beginn einer Erweiterung helfen, wenn Handwerker selten sind.",
        ["dialog.item.keywords"]                  = "Gegenstandsschlüsselwörter",
        ["dialog.item.keywords.tooltip.body"]     = "Eine kommagetrennte Liste von Schlüsselwörtern. Schlüsselwortübereinstimmung wird verwendet, wenn eine Anfrage keinen Gegenstandslink enthält. Nach der Übereinstimmung mit einem bestimmten Beruf werden diese Schlüsselwörter überprüft, um die Übereinstimmung auf einen bestimmten Gegenstand zu verfeinern.",
        ["dialog.item.secondary_keywords"]        = "Sekundäre Gegenstandsschlüsselwörter",
        ["dialog.item.secondary_keywords.tooltip.body"] = "Nach der Übereinstimmung mit einem Schlüsselwort oben wird eine Nachricht auf sekundäre Schlüsselwörter überprüft, um die Übereinstimmung zu verfeinern, sodass die verschiedenen Handwerke für denselben Gegenstandsplatz unterschieden werden können. Der Gegenstand mit den meisten sekundären Schlüsselwortübereinstimmungen wird ausgewählt. Es ist eine gute Idee, Ersetzungs-Tags in sekundären Schlüsselwörtern zu verwenden, damit sie global von Saison zu Saison geändert werden können, wenn sich die Gegenstandsstufen ändern.",
        ["dialog.item.commission"]                = "Gegenstandsprovision",
        ["dialog.item.commission.tooltip.body"]   = "Zum Beispiel '10000g', Standard: 'Beliebig'\nDieser Text erscheint in der Tabelle 'Handwerker finden' des Kunden.",
        ["dialog.item.greeting"]                  = "Gegenstandsbegrüßung",
        ["dialog.item.greeting.tooltip.body"]     = "Eine gegenstandsspezifische Begrüßung, wenn dieser Gegenstand übereinstimmt. Dies wird nach der allgemeinen und der Berufsbegrüßung angehängt.",
        ["dialog.item.omit_general"]              = "Allgemeine Begrüßung weglassen",
        ["dialog.item.omit_general.tooltip.body"] = "Die allgemeine Begrüßung weglassen, wenn der Kunde wegen dieses Gegenstands begrüßt wird.",
        ["dialog.item.omit_profession"]           = "Berufsbegrüßung weglassen",
        ["dialog.item.omit_profession.tooltip.body"] = "Die Berufsbegrüßung weglassen, wenn der Kunde wegen dieses Gegenstands begrüßt wird.",
        ["default.tag.value"]                     = "Konfiguriere diesen Tag in der Kategorie 'Ersetzungs-Tags'.",
        ["dialog.contains_substitution_tags.tooltip.title"] = "Dieser Text enthält Ersetzungs-Tags.",
        ["dialog.contains_substitution_tags.tooltip.body"] = "Tags werden bei der Anzeige erweitert und während der Bearbeitung ausgeblendet.",
        ["dialog.disable_scan_state"]             = "Scannen deaktivieren",
        ["dialog.disable_scan_state.tooltip.body"] = "Chat nicht nach diesem Gegenstand scannen.\n\nDieser Gegenstand wird in den Abschnitt 'Scannen aus' verschoben und kann jederzeit wieder aktiviert werden.",
        ["dialog.enable_scan_state"]              = "Scannen aktivieren",
        ["dialog.enable_scan_state.tooltip.body"] = "Chat nach diesem Gegenstand scannen.\n\nEine Nachricht mit einem Link zu diesem Gegenstand löst eine Übereinstimmung aus.\n\nEin Berufsschlüsselwort gefolgt von einem Gegenstandsschlüsselwort löst ebenfalls eine Übereinstimmung aus.\n\nDieser Gegenstand wird in den Abschnitt 'Scannen ein' verschoben und kann jederzeit wieder deaktiviert werden.",
        ["tag.invalid.braces"]                    = "Tags dürfen keine '{' oder '}' enthalten.",
        ["tag.invalid.unique"]                    = "Tags müssen eindeutig sein.",
        ["tag.invalid.context"]                   = "Dies ist ein integrierter kontextsensitiver Tag. Er wird nur in Begrüßungen unterstützt und durch Details basierend auf der Kundenanfrage ersetzt.",
        ["dialog.prof.keywords"]                  = "Berufsschlüsselwörter",
        ["dialog.prof.keywords.tooltip.body"]     = "Eine kommagetrennte Liste von Schlüsselwörtern. Schlüsselwortübereinstimmung wird verwendet, wenn eine Anfrage keinen Gegenstandslink enthält.\n\nEin Berufsbegriff muss in der Nachricht gefunden werden, bevor Gegenstandsschlüsselwörter überprüft werden.\n\nDies sollte alles enthalten, was ein Kunde sagen könnte, das auf einen bestimmten Beruf hinweist, wie z.B. 'Platte' für Schmiedekunst.",
        ["dialog.prof.exclusions"]                = "Schwarze Liste Berufsschlüsselwörter",
        ["dialog.prof.exclusions.tooltip.body"]   = "Eine kommagetrennte Liste von Schlüsselwörtern. Eine Nachricht, die mit dem Beruf übereinstimmt, aber eines dieser Schlüsselwörter enthält, wird nicht als Berufsübereinstimmung betrachtet.\n\nDer Hauptanwendungsfall für diese Liste sind Berufswerkzeuge. Anfragen enthalten oft den Beruf des Werkzeugs, das der Kunde möchte, nicht den Beruf, der es herstellen kann. Zum Beispiel sucht 'LF Alch Tool' wahrscheinlich jemanden, der Schneider oder Inschriftenkundler ist, um ihm ein Werkzeug für Alchemie herzustellen, daher sollten wir das nicht mit Alchemie abgleichen.",
        ["dialog.prof.commission"]                = "Berufsprovision",
        ["dialog.prof.commission.tooltip.body"]   = "Zum Beispiel '10000g', Standard: 'Beliebig'\nDieser Text erscheint in der Tabelle 'Handwerker finden' des Kunden.\n\nWenn angegeben, überschreibt die gegenstandsspezifische Provision diesen Wert.",
        ["dialog.prof.greeting"]                  = "Berufsbegrüßung",
        ["dialog.prof.greeting.tooltip.body"]     = "Eine berufsspezifische Begrüßung, die nach der allgemeinen Begrüßung und vor der Gegenstandsbegrüßung eingefügt wird.\n\nDiese Begrüßung kann auf Gegenstandsbasis über die Option 'Berufsbegrüßung weglassen' weggelassen werden.",
        ["dialog.prof.omit_general"]              = "Allgemeine Begrüßung weglassen",
        ["dialog.prof.omit_general.tooltip.body"] = "Die allgemeine Begrüßung weglassen, wenn der Kunde wegen dieses Berufs begrüßt wird.",
        ["dialog.tag.header.key"]                 = "Tags",
        ["dialog.tag.header.value"]               = "Ersatzwerte",
        ["dialog.tag.header"]                     = "Ersetzungs-Tags",
        ["dialog.tag.header.tooltip.body"]        = "Ersetzungs-Tags können in Begrüßungen und Schlüsselwortfeldern in der gesamten Benutzeroberfläche verwendet werden.\n\nWenn Tags verwendet werden, zeigt die Benutzeroberfläche den Tag selbst beim Bearbeiten und den Ersatzwert an, wenn nicht bearbeitet wird.\n\nTags sollen das Aktualisieren saisonaler Inhalte und das Vermeiden von Duplikaten unterstützen.\n\nSchlüsselwörter für jeden Gegenstand können mit einem Tag für den Gegenstandsplatz konfiguriert werden. Zum Beispiel können alle Armschienen über alle Berufe hinweg einen Tag teilen, der auf dieselbe Liste von armschienenähnlichen Wörtern verweist.\n\nSekundäre Schlüsselwörter enthalten oft Gegenstandsstufen, die sich von Saison zu Saison ändern. Konfiguriere sie mit den standardmäßigen tab-vervollständigbaren {Epic}, {Blue} und {pvp} Tags, und aktualisiere dann jede Saison die Gegenstandsstufen an einem Ort für alle Berufe und Gegenstände.\n\nSetze die Provision in all deinen Begrüßungen auf einen Tag, und nimm die Leute aus, wenn die Konkurrenz offline ist.",
        ["dialog.tag.new"]                        = "Neuen Tag erstellen",
        ["dialog.tag.new.tooltip.body"]           = "Tags müssen eindeutig sein und dürfen keine '{' oder '}' enthalten.",
        ["dialog.tag.new.button"]                 = "Erstellen",
        ["dialog.tag.copy"]                       = "Kopiere {%s}",
        ["dialog.tag.delete"]                     = "Lösche {%s}",
        ["dialog.tag.delete.help"]                = "Rechtsklick auf einen Tag zum Löschen",
        ["dialog.tag.autocomplete_enabled"]       = "Autovervollständigen",
        ["dialog.tag.autocomplete_enabled.tooltip.body"] = "Wenn aktiviert, vervollständigen Texteingaben Tags während der Eingabe automatisch.",
        [LID.RN_DISCORD]                          = "Discord",
        [LID.RN_DISCORD + 1]                      = "https://discord.gg/BCnAswxsSj",
        [LID.RN_DISCORD + 2]                      = "Um eine Anfrage zu stellen, damit dieses Feld Kopieren/Einfügen unterstützt, gehe zu:",
        [LID.RN_DISCORD + 3]                      = "https://github.com/stevin05/CraftScan",
        [LID.RN_CONFIG_REWORK]                    = "Konfigurationsüberarbeitung",
        [LID.RN_CONFIG_REWORK + 1]                = "In Vorbereitung auf Midnight und die ständigen Konfigurationsänderungen, die beim Erlernen neuer Berufsbäume erforderlich sind, wurde die Benutzeroberfläche aktualisiert, um leichter zu sehen, für welche Gegenstände das Scannen aktiviert ist.",
        [LID.RN_CONFIG_REWORK + 2]                = "Die Berufs- und Begrüßungskonfiguration wurde in ein eigenes Panel verschoben. Nachdem ein Beruf einmal geöffnet wurde, kann jeder Charakter ihn über das neue Menü konfigurieren.",
        [LID.RN_CONFIG_REWORK + 3]                = "Das Scannen von Gegenständen hat jetzt vier Zustände: ausstehende Überprüfung, ein, aus und nicht gelernt. Wenn Rezepte gelernt werden, werden sie zur ausstehenden Überprüfung verschoben, was es einfach macht, zu verfolgen, was du aktivieren möchtest.",
        [LID.RN_CONFIG_REWORK + 4]                = "Dieses neue Panel kann über die Schaltfläche 'Konfig' oben in 'Chat-Aufträge' oder die übliche Schaltfläche 'CraftScan anzeigen' im Berufsfenster aufgerufen werden.",
        [LID.RN_SUBSTITUTION_TAGS]                = "Ersetzungs-Tags",
        [LID.RN_SUBSTITUTION_TAGS + 1]            = "Ersetzungs-Tags können jetzt in Begrüßungen und Schlüsselwörtern in der gesamten Benutzeroberfläche verwendet werden.",
        [LID.RN_SUBSTITUTION_TAGS + 2]            = "Tags sollen das schnelle Aktualisieren saisonaler Inhalte und das Vermeiden von Duplikaten unterstützen.",
        [LID.RN_SUBSTITUTION_TAGS + 3]            = "Saisonale Gegenstandsstufen sind oft in sekundären Schlüsselwörtern enthalten. Sekundäre Schlüsselwörter vervollständigen jetzt mit Tab zu 'Epic', 'Rare' und 'pvp' Tags, die verwendet werden können, um Gegenstandsstufen an einem Ort für einfache Updates festzulegen.",
        [LID.RN_SUBSTITUTION_TAGS + 4]            = "Gängige Abkürzungen für Gegenstände sind oft in Gegenstandsschlüsselwörtern enthalten. Diese können jetzt über Berufe und Seltenheiten hinweg geteilt werden, sodass du jeden Slot nur einmal einrichten musst. Gegenstandsschlüsselwörter vervollständigen jetzt mit Tab zu einem Gegenstandsplatz-Tag.",
        [LID.RN_SUBSTITUTION_TAGS + 5]            = "Begrüßungen unterstützen auch Tags, sodass du Provisionen einfach kategorisieren und aktualisieren kannst, wenn die Konkurrenz sich an- und abmeldet.",
        [LID.RN_SUBSTITUTION_TAGS + 6]            = "Mit der Einführung von Tags wurde die Unterstützung für Konfigurationen basierend auf den integrierten Berufskategorien entfernt. Du kannst jetzt stattdessen deine eigenen Gruppierungen über Tags erstellen.",
        [LID.RN_SUBSTITUTION_TAGS + 7]            = "Tags unterstützen ein sehr rudimentäres Autovervollständigungssystem. Auswahlmöglichkeiten erscheinen während der Eingabe, und sobald es nur noch eine mögliche Wahl gibt, wird der Tag für dich vervollständigt. Wenn es zu nervig ist, kann es deaktiviert werden.",
        ["Concentration Dependent"]               = "Konzentrationsabhängig",
        ["dialog.item.required_concentration"]    = "Erforderliche Konzentration",
        ["dialog.item.required_concentration.tooltip.body"] = "Scanne diesen Gegenstand bedingt basierend auf der verfügbaren Konzentration.\n\nDie genaue Menge an erforderlicher Konzentration hängt von deinem Berufszweig und den bereitgestellten Materialien ab. Verwende den Simulationsmodus in CraftSim, um eine gute Schätzung zu erhalten.\n\nWenn auf einen Wert ungleich Null gesetzt, wird dieses Rezept in einen separaten Abschnitt verschoben, der anzeigt, dass das Scannen von der Konzentration abhängt.",
        ["dialog.item.required_concentration.tooltip.body.ready"] = "Aktuelle Konzentration: %d.\n\nScannen ein.",
        ["dialog.item.required_concentration.tooltip.body.cooldown"] = "Aktuelle Konzentration: %d.\n\nScannen wird in %s aktiviert.",
        ["dialog.pending_review_state"]           = "Ausstehende Überprüfung",
        ["dialog.pending_review_state.tooltip.body"] = "Verschiebe dieses Rezept zurück in den Abschnitt für ausstehende Überprüfungen.\n\nAusstehende Überprüfung ist als Wartebereich gedacht, damit du Rezepte leicht verfolgen kannst, die du aktivieren möchtest, sobald du genug Wissen hast, um sie auf maximalem Rang herzustellen.",
        ["Open in CraftScan"]                     = "CraftScan anhängen",
        ["dialog.enable_all"]                     = "Alle aktivieren",
        ["dialog.enable_all.tooltip.body"]        = "Aktiviere das Scannen für alle Rezepte, die derzeit zur Überprüfung ausstehen. Nicht gelernte Rezepte werden nicht automatisch aktiviert, wenn sie gelernt werden.",
        ["Not supported"]                         = "Nicht scannbar",
        ["decor"]                                 = "Dekor",
        ["Loading..."]                            = "Laden...",
        ["Hide CraftScan"]                        = "CraftScan lösen",
    }
end
