...
function CraftScan.LOCAL_TW:GetData()
    ...
    return {
        ...
        [LID.CONFIG_TOGGLE_BINDING_NAME]          = "切換設定頁面",
        ["Config"]                                = "設定",
        ["DELETED"]                               = "已刪除",
        ["Crafters"]                              = "工匠",
        ["Legacy Crafters"]                       = "舊版工匠",
        [LID.PENDING_REVIEW]                      = "待審核",
        [LID.SCANNING_ON]                         = "掃描開啟",
        [LID.SCANNING_OFF]                        = "掃描關閉",
        [LID.UNLEARNED]                           = "未學習",
        ["General"]                               = "一般",
        ["Base Filters"]                          = "基礎過濾器",
        ["Customer Greetings"]                    = "客戶問候",
        ["Unsaved Changes"]                       = "您的變更尚未儲存。",
        ["dialog.inclusions"]                     = "必要關鍵詞",
        ["dialog.inclusions.tooltip.body"]        = "逗號分隔的關鍵詞列表。這些關鍵詞是匹配的第一層。任何不包含這些詞之一的消息都將被忽略。",
        ["dialog.exclusions"]                     = "黑名單關鍵詞",
        ["dialog.exclusions.tooltip.body"]        = "逗號分隔的關鍵詞列表。這些關鍵詞是匹配的第一層。任何包含這些詞之一的消息都將被忽略。",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM"]      = "我可以製造 {item}。",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM.tooltip.body"] = "當前角色可以製造請求的物品時發送給客戶的消息。",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM"]    = "我的小號，{crafter}，可以製造 {item}。",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM.tooltip.body"] = "當小號可以製造請求的物品時發送給客戶的消息。",
        ["dialog.GREETING_I_HAVE_PROF"]           = "我有 {profession}。",
        ["dialog.GREETING_I_HAVE_PROF.tooltip.body"] = "當前角色擁有請求的職業時發送給客戶的消息。",
        ["dialog.GREETING_ALT_HAS_PROF"]          = "我的小號，{crafter}，有 {profession}。",
        ["dialog.GREETING_ALT_HAS_PROF.tooltip.body"] = "當小號擁有請求的職業時發送給客戶的消息。",
        ["dialog.GREETING_ALT_SUFFIX"]            = "讓我知道以便切換角色。",
        ["dialog.GREETING_ALT_SUFFIX.tooltip.body"] = "當小號是工匠時附加到問候語的額外句子。",
        ["dialog.GREETING_BUSY"]                  = "我現在很忙，但稍後可以製造。",
        ["dialog.GREETING_BUSY.tooltip.body"]     = "當選中“忙碌模式”框時附加到問候語的額外句子。這旨在與第二個帳戶結合使用，以便您可以在玩遊戲的同時，第二個帳戶在城裡代理訂單給您稍後處理。\n\n隨著Midnight中的插件更改，這可能不再非常有用，但在擴展開始工匠稀缺時可能會有所幫助。",
        ["dialog.item.keywords"]                  = "物品關鍵詞",
        ["dialog.item.keywords.tooltip.body"]     = "逗號分隔的關鍵詞列表。當請求不包含物品連結時使用關鍵詞匹配。在匹配特定職業後，檢查這些關鍵詞以精確匹配特定物品。",
        ["dialog.item.secondary_keywords"]        = "次要物品關鍵詞",
        ["dialog.item.secondary_keywords.tooltip.body"] = "在匹配上述關鍵詞後，檢查消息中的次要關鍵詞以精確匹配，允許區分同一物品槽的不同工藝。具有最多此要關鍵詞匹配的物品將被選中。在次要關鍵詞中使用替換標籤是個好主意，這樣隨著物品等級的變化，可以輕鬆地在全球範圍內按季節更改。",
        ["dialog.item.commission"]                = "物品佣金",
        ["dialog.item.commission.tooltip.body"]   = "例如，'10000g'，默認：'任意'\n此文本出現在客戶的“尋找工匠”表中。",
        ["dialog.item.greeting"]                  = "物品問候",
        ["dialog.item.greeting.tooltip.body"]     = "當此物品匹配時的特定物品問候。這附加在常規和職業問候之後。",
        ["dialog.item.omit_general"]              = "省略常規問候",
        ["dialog.item.omit_general.tooltip.body"] = "當關於此物品問候客戶時省略常規問候。",
        ["dialog.item.omit_profession"]           = "省略職業問候",
        ["dialog.item.omit_profession.tooltip.body"] = "當關於此物品問候客戶時省略職業問候。",
        ["default.tag.value"]                     = "在“替換標籤”類別中配置此標籤。",
        ["dialog.contains_substitution_tags.tooltip.title"] = "此文本包含替換標籤。",
        ["dialog.contains_substitution_tags.tooltip.body"] = "標籤在顯示時展開，在編輯時折疊。",
        ["dialog.disable_scan_state"]             = "禁用掃描",
        ["dialog.disable_scan_state.tooltip.body"] = "不掃描此物品的聊天。\n\n此物品將被放置在“掃描關閉”部分，可以隨時再次啟用。",
        ["dialog.enable_scan_state"]              = "啟用掃描",
        ["dialog.enable_scan_state.tooltip.body"] = "掃描此物品的聊天。\n\n帶有此物品連結的消息將觸發匹配。\n\n職業關鍵詞後跟物品關鍵詞也將觸發匹配。\n\n此物品將被放置在“掃描開啟”部分，可以隨時再次禁用。",
        ["tag.invalid.braces"]                    = "標籤不能包含 '{' 或 '}'。",
        ["tag.invalid.unique"]                    = "標籤必須是唯一的。",
        ["tag.invalid.context"]                   = "這是一個內置的上下文敏感標籤。它僅在問候語中受支持，並將根據客戶請求替換為詳細信息。",
        ["dialog.prof.keywords"]                  = "職業關鍵詞",
        ["dialog.prof.keywords.tooltip.body"]     = "逗號分隔的關鍵詞列表。當請求不包含物品連結時使用關鍵詞匹配。\n\n在檢查任何物品關鍵詞之前，必須在消息中找到職業術語。\n\n這應包括客戶可能說的任何表明特定職業的內容，例如鍛造的“板甲”。",
        ["dialog.prof.exclusions"]                = "黑名單職業關鍵詞",
        ["dialog.prof.exclusions.tooltip.body"]   = "逗號分隔的關鍵詞列表。匹配職業但包含這些關鍵詞之一的消息將不被視為職業匹配。\n\n此列表的主要用例是職業工具。請求通常包括客戶想要的工具的職業，而不是可以創建它的職業。例如，“LF alc tool”可能是某人尋找裁縫或銘文師為他們製作鍊金術工具，因此我們不應將其與鍊金術匹配。",
        ["dialog.prof.commission"]                = "職業佣金",
        ["dialog.prof.commission.tooltip.body"]   = "例如，'10000g'，默認：'任意'\n此文本出現在客戶的“尋找工匠”表中。\n\n如果指定，物品特定佣金將覆蓋此值。",
        ["dialog.prof.greeting"]                  = "職業問候",
        ["dialog.prof.greeting.tooltip.body"]     = "將包含在常規問候之後和物品問候之前的特定職業問候。\n\n可以通過“省略職業問候”選項逐個物品省略此問候。",
        ["dialog.prof.omit_general"]              = "省略常規問候",
        ["dialog.prof.omit_general.tooltip.body"] = "當關於此職業問候客戶時省略常規問候。",
        ["dialog.tag.header.key"]                 = "標籤",
        ["dialog.tag.header.value"]               = "替換值",
        ["dialog.tag.header"]                     = "替換標籤",
        ["dialog.tag.header.tooltip.body"]        = "替換標籤可以在整個UI的問候語和關鍵詞框中使用。\n\n當使用標籤時，UI將在編輯時顯示標籤本身，在不編輯時顯示替換值。\n\n標籤旨在支持更新季節性內容並避免重複。\n\n每個物品的關鍵詞可以使用物品槽的標籤進行配置。例如，所有職業的所有護腕可以共享一個引用相同護腕類詞列表的標籤。\n\n次要關鍵詞通常包括隨季節變化的物品等級。使用默認的可通過Tab鍵補全的 {Epic}, {Blue} 和 {pvp} 標籤配置它們，然後每個季節在一個地方更新所有職業和物品的物品等級。\n\n將所有問候語中的佣金設置為標籤，然後在競爭對手離線時敲詐那些傻瓜。",
        ["dialog.tag.new"]                        = "創建新標籤",
        ["dialog.tag.new.tooltip.body"]           = "標籤必須是唯一的，且不能包含 '{' 或 '}'。",
        ["dialog.tag.new.button"]                 = "創建",
        ["dialog.tag.copy"]                       = "複製 {%s}",
        ["dialog.tag.delete"]                     = "刪除 {%s}",
        ["dialog.tag.delete.help"]                = "右鍵點擊標籤以刪除",
        ["dialog.tag.autocomplete_enabled"]       = "自動完成",
        ["dialog.tag.autocomplete_enabled.tooltip.body"] = "啟用時，文本輸入會在鍵入時自動完成標籤。",
        [LID.RN_DISCORD]                          = "Discord",
        [LID.RN_DISCORD + 1]                      = "https://discord.gg/BCnAswxsSj",
        [LID.RN_DISCORD + 2]                      = "要提交請求使此框支持複製/粘貼，請轉到：",
        [LID.RN_DISCORD + 3]                      = "https://github.com/stevin05/CraftScan",
        [LID.RN_CONFIG_REWORK]                    = "配置重做",
        [LID.RN_CONFIG_REWORK + 1]                = "為了準備Midnight以及學習新職業樹時所需的持續配置更改，UI已更新，以便更容易查看哪些物品啟用了掃描。",
        [LID.RN_CONFIG_REWORK + 2]                = "職業和問候配置已移動到其自己的面板。打開一次職業後，任何角色都可以從新菜單配置它。",
        [LID.RN_CONFIG_REWORK + 3]                = "物品掃描現在有四種狀態：待審核、開啟、關閉和未學習。隨著配方的學習，它們會移動到待審核，使您可以輕鬆跟踪可能想要啟用的內容。",
        [LID.RN_CONFIG_REWORK + 4]                = "此新面板可以通過“聊天訂單”頂部的“配置”按鈕或職業窗口中通常的“顯示CraftScan”按鈕訪問。",
        [LID.RN_SUBSTITUTION_TAGS]                = "替換標籤",
        [LID.RN_SUBSTITUTION_TAGS + 1]            = "替換標籤現在可以在整個UI的問候語和關鍵詞中使用。",
        [LID.RN_SUBSTITUTION_TAGS + 2]            = "標籤旨在支持快速更新季節性內容並避免重複。",
        [LID.RN_SUBSTITUTION_TAGS + 3]            = "季節性物品等級通常包含在次要關鍵詞中。次要關鍵詞現在可以通過Tab鍵補全為 'Epic', 'Rare' 和 'pvp' 標籤，這些標籤可用於在一個地方設置物品等級以便輕鬆更新。",
        [LID.RN_SUBSTITUTION_TAGS + 4]            = "物品的常見縮寫通常包含在物品關鍵詞中。這些現在可以在職業和稀有度之間共享，因此您只需設置每個插槽一次。物品關鍵詞現在可以通過Tab鍵補全為物品槽標籤。",
        [LID.RN_SUBSTITUTION_TAGS + 5]            = "問候語也支持標籤，因此您可以輕鬆分類並在競爭對手登錄和註銷時更新佣金。",
        [LID.RN_SUBSTITUTION_TAGS + 6]            = "隨著標籤的引入，已移除對基於內置職業類別的配置的支持。您現在可以通過標籤創建自己的分組。",
        [LID.RN_SUBSTITUTION_TAGS + 7]            = "標籤支持非常基本的自動完成系統。選項會在您鍵入時彈出，一旦只有一個可能的選擇，它就會為您完成標籤。如果太煩人，可以禁用它。",
        ["Concentration Dependent"]               = "依賴專注",
        ["dialog.item.required_concentration"]    = "所需專注",
        ["dialog.item.required_concentration.tooltip.body"] = "根據可用專注有條件地掃描此物品。\n\n所需專注的確切數量取決於您的職業樹和提供的材料。使用CraftSim中的模擬模式得出一個好的估計。\n\n當設置為非零值時，此配方將被放置在一個單獨的部分，指示掃描取決於專注。",
        ["dialog.item.required_concentration.tooltip.body.ready"] = "當前專注：%d。\n\n掃描開啟。",
        ["dialog.item.required_concentration.tooltip.body.cooldown"] = "當前專注：%d。\n\n掃描將在 %s 後啟用。",
        ["dialog.pending_review_state"]           = "待審核",
        ["dialog.pending_review_state.tooltip.body"] = "將此配方移回待審核部分。\n\n待審核旨在作為一個暫存區，以便您可以輕鬆跟踪打算在擁有足夠知識以最高等級製作時啟用的配方。",
        ["Open in CraftScan"]                     = "附加CraftScan",
        ["dialog.enable_all"]                     = "全部啟用",
        ["dialog.enable_all.tooltip.body"]        = "啟用對當前待審核的所有配方的掃描。未學習的配方在學習時不會自動啟用。",
        ["Not supported"]                         = "不可掃描",
        ["decor"]                                 = "裝飾",
        ["Loading..."]                            = "載入中...",
        ["Hide CraftScan"]                        = "分離CraftScan",
    }
end
