...
function CraftScan.LOCAL_IT:GetData()
    ...
    return {
        ...
        [LID.CONFIG_TOGGLE_BINDING_NAME]          = "Attiva/Disattiva pagina di configurazione",
        ["Config"]                                = "Config",
        ["DELETED"]                               = "ELIMINATO",
        ["Crafters"]                              = "Artigiani",
        ["Legacy Crafters"]                       = "Vecchi Artigiani",
        [LID.PENDING_REVIEW]                      = "In attesa di revisione",
        [LID.SCANNING_ON]                         = "Scansione attiva",
        [LID.SCANNING_OFF]                        = "Scansione disattiva",
        [LID.UNLEARNED]                           = "Non appreso",
        ["General"]                               = "Generale",
        ["Base Filters"]                          = "Filtri base",
        ["Customer Greetings"]                    = "Saluti cliente",
        ["Unsaved Changes"]                       = "Le tue modifiche non sono state salvate.",
        ["dialog.inclusions"]                     = "Parole chiave richieste",
        ["dialog.inclusions.tooltip.body"]        = "Un elenco di parole chiave separate da virgola. Queste parole chiave sono il primo livello di corrispondenza. Qualsiasi messaggio che non includa una di queste parole verrà ignorato.",
        ["dialog.exclusions"]                     = "Parole chiave nella lista nera",
        ["dialog.exclusions.tooltip.body"]        = "Un elenco di parole chiave separate da virgola. Queste parole chiave sono il primo livello di corrispondenza. Qualsiasi messaggio che includa una di queste parole verrà ignorato.",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM"]      = "Posso creare {item}.",
        ["dialog.GREETING_I_CAN_CRAFT_ITEM.tooltip.body"] = "Il messaggio da inviare ai clienti quando il personaggio corrente può creare l'oggetto richiesto.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM"]    = "Il mio alter, {crafter}, può creare {item}.",
        ["dialog.GREETING_ALT_CAN_CRAFT_ITEM.tooltip.body"] = "Il messaggio da inviare ai clienti quando un alter può creare l'oggetto richiesto.",
        ["dialog.GREETING_I_HAVE_PROF"]           = "Ho {profession}.",
        ["dialog.GREETING_I_HAVE_PROF.tooltip.body"] = "Il messaggio da inviare ai clienti quando il personaggio corrente ha la professione richiesta.",
        ["dialog.GREETING_ALT_HAS_PROF"]          = "Il mio alter, {crafter}, ha {profession}.",
        ["dialog.GREETING_ALT_HAS_PROF.tooltip.body"] = "Il messaggio da inviare ai clienti quando un alter ha la professione richiesta.",
        ["dialog.GREETING_ALT_SUFFIX"]            = "Fammi sapere per cambiare personaggio.",
        ["dialog.GREETING_ALT_SUFFIX.tooltip.body"] = "Una frase aggiuntiva aggiunta al saluto quando un alter è l'artigiano.",
        ["dialog.GREETING_BUSY"]                  = "Sono occupato ora, ma posso crearlo più tardi.",
        ["dialog.GREETING_BUSY.tooltip.body"]     = "Una frase aggiuntiva aggiunta al saluto quando la casella 'Modalità Occupata' è selezionata. Questo è destinato all'uso in combinazione con un secondo account, in modo da poter giocare mentre il secondo account rimane in città e ti inoltra gli ordini per occupartene più tardi.\n\nCon le modifiche all'addon in Midnight, questo probabilmente non è più molto utile, ma potrebbe aiutare all'inizio di un'espansione quando gli artigiani sono rari.",
        ["dialog.item.keywords"]                  = "Parole chiave oggetto",
        ["dialog.item.keywords.tooltip.body"]     = "Un elenco di parole chiave separate da virgola. La corrispondenza delle parole chiave viene utilizzata quando una richiesta non include un link all'oggetto. Dopo aver trovato una corrispondenza con una professione specifica, queste parole chiave vengono controllate per perfezionare la corrispondenza con un oggetto specifico.",
        ["dialog.item.secondary_keywords"]        = "Parole chiave secondarie oggetto",
        ["dialog.item.secondary_keywords.tooltip.body"] = "Dopo aver trovato una corrispondenza con una parola chiave sopra, un messaggio viene controllato per parole chiave secondarie per perfezionare la corrispondenza, consentendo di differenziare le varie creazioni per lo stesso slot oggetto. Verrà selezionato l'oggetto con il maggior numero di corrispondenze di parole chiave secondarie. È una buona idea utilizzare tag di sostituzione nelle parole chiave secondarie in modo che possano essere facilmente modificate globalmente di stagione in stagione man mano che i livelli degli oggetti cambiano.",
        ["dialog.item.commission"]                = "Commissione oggetto",
        ["dialog.item.commission.tooltip.body"]   = "Ad esempio, '10000g', Predefinito: 'Qualsiasi'\nQuesto testo appare nella tabella 'Trova Artigiano' del cliente.",
        ["dialog.item.greeting"]                  = "Saluto oggetto",
        ["dialog.item.greeting.tooltip.body"]     = "Un saluto specifico per l'oggetto quando questo oggetto è stato abbinato. Questo viene aggiunto dopo il saluto generale e della professione.",
        ["dialog.item.omit_general"]              = "Ometti saluto generale",
        ["dialog.item.omit_general.tooltip.body"] = "Ometti il saluto generale quando saluti il cliente riguardo a questo oggetto.",
        ["dialog.item.omit_profession"]           = "Ometti saluto professione",
        ["dialog.item.omit_profession.tooltip.body"] = "Ometti il saluto della professione quando saluti il cliente riguardo a questo oggetto.",
        ["default.tag.value"]                     = "Configura questo tag nella categoria 'Tag di Sostituzione'.",
        ["dialog.contains_substitution_tags.tooltip.title"] = "Questo testo include tag di sostituzione.",
        ["dialog.contains_substitution_tags.tooltip.body"] = "I tag vengono espansi quando visualizzati e compressi durante la modifica.",
        ["dialog.disable_scan_state"]             = "Disabilita scansione",
        ["dialog.disable_scan_state.tooltip.body"] = "Non scansionare la chat per questo oggetto.\n\nQuesto oggetto verrà inserito nella sezione 'Scansione disattiva' e potrà essere riattivato in qualsiasi momento.",
        ["dialog.enable_scan_state"]              = "Abilita scansione",
        ["dialog.enable_scan_state.tooltip.body"] = "Scansiona la chat per questo oggetto.\n\nUn messaggio con un link a questo oggetto attiverà una corrispondenza.\n\nUna parola chiave della professione seguita da una parola chiave dell'oggetto attiverà anche una corrispondenza.\n\nQuesto oggetto verrà inserito nella sezione 'Scansione attiva' e potrà essere disattivato in qualsiasi momento.",
        ["tag.invalid.braces"]                    = "I tag non possono includere '{' o '}'.",
        ["tag.invalid.unique"]                    = "I tag devono essere unici.",
        ["tag.invalid.context"]                   = "Questo è un tag sensibile al contesto integrato. È supportato solo nei saluti e verrà sostituito con dettagli basati sulla richiesta del cliente.",
        ["dialog.prof.keywords"]                  = "Parole chiave professione",
        ["dialog.prof.keywords.tooltip.body"]     = "Un elenco di parole chiave separate da virgola. La corrispondenza delle parole chiave viene utilizzata quando una richiesta non include un link all'oggetto.\n\nUn termine della professione deve essere trovato nel messaggio prima che vengano controllate le parole chiave dell'oggetto.\n\nQuesto dovrebbe includere tutto ciò che un cliente potrebbe dire che indica una professione specifica, come 'piastre' per Forgiatura.",
        ["dialog.prof.exclusions"]                = "Parole chiave professione nella lista nera",
        ["dialog.prof.exclusions.tooltip.body"]   = "Un elenco di parole chiave separate da virgola. Un messaggio che corrisponde alla professione ma include una di queste parole chiave non sarà considerato una corrispondenza di professione.\n\nIl caso d'uso principale per questo elenco sono gli strumenti di professione. Le richieste spesso includono la professione dello strumento che il cliente desidera, non la professione che può crearlo. Ad esempio, 'LF alc tool' è probabilmente qualcuno che cerca un Sarto o un Iscrivano per fargli uno strumento per Alchimia, quindi non dovremmo abbinarlo ad Alchimia.",
        ["dialog.prof.commission"]                = "Commissione professione",
        ["dialog.prof.commission.tooltip.body"]   = "Ad esempio, '10000g', Predefinito: 'Qualsiasi'\nQuesto testo appare nella tabella 'Trova Artigiano' del cliente.\n\nSe specificato, la commissione specifica dell'oggetto sovrascrive questo valore.",
        ["dialog.prof.greeting"]                  = "Saluto professione",
        ["dialog.prof.greeting.tooltip.body"]     = "Un saluto specifico della professione che verrà incluso dopo il saluto generale e prima del saluto dell'oggetto.\n\nQuesto saluto può essere omesso oggetto per oggetto tramite l'opzione 'Ometti saluto professione'.",
        ["dialog.prof.omit_general"]              = "Ometti saluto generale",
        ["dialog.prof.omit_general.tooltip.body"] = "Ometti il saluto generale quando saluti il cliente riguardo a questa professione.",
        ["dialog.tag.header.key"]                 = "Tag",
        ["dialog.tag.header.value"]               = "Valori di sostituzione",
        ["dialog.tag.header"]                     = "Tag di Sostituzione",
        ["dialog.tag.header.tooltip.body"]        = "I tag di sostituzione possono essere utilizzati nei saluti e nelle caselle delle parole chiave in tutta l'interfaccia utente.\n\nQuando i tag sono in uso, l'interfaccia utente visualizzerà il tag stesso durante la modifica e il valore di sostituzione quando non si modifica.\n\nI tag sono destinati a supportare l'aggiornamento dei contenuti stagionali ed evitare duplicazioni.\n\nLe parole chiave per ogni oggetto possono essere configurate utilizzando un tag per lo slot dell'oggetto. Ad esempio, tutti i bracciali in tutte le professioni possono condividere un tag che si riferisce allo stesso elenco di parole simili a bracciali.\n\nLe parole chiave secondarie spesso includono livelli oggetto che cambiano di stagione in stagione. Configurali con i tag predefiniti completabili con tabulazione {Epic}, {Blue} e {pvp}, e poi ogni stagione, aggiorna i livelli degli oggetti in un unico posto per tutte le professioni e gli oggetti.\n\nImposta la commissione in tutti i tuoi saluti su un tag, e poi spenna quei babbei quando la concorrenza è offline.",
        ["dialog.tag.new"]                        = "Crea un nuovo tag",
        ["dialog.tag.new.tooltip.body"]           = "I tag devono essere unici e non possono includere '{' o '}'.",
        ["dialog.tag.new.button"]                 = "Crea",
        ["dialog.tag.copy"]                       = "Copia {%s}",
        ["dialog.tag.delete"]                     = "Elimina {%s}",
        ["dialog.tag.delete.help"]                = "Clic destro su un tag per eliminare",
        ["dialog.tag.autocomplete_enabled"]       = "Completamento automatico",
        ["dialog.tag.autocomplete_enabled.tooltip.body"] = "Se abilitato, gli input di testo completano automaticamente i tag durante la digitazione.",
        [LID.RN_DISCORD]                          = "Discord",
        [LID.RN_DISCORD + 1]                      = "https://discord.gg/BCnAswxsSj",
        [LID.RN_DISCORD + 2]                      = "Per inviare una richiesta per far sì che questa casella supporti copia/incolla, vai a:",
        [LID.RN_DISCORD + 3]                      = "https://github.com/stevin05/CraftScan",
        [LID.RN_CONFIG_REWORK]                    = "Rielaborazione Configurazione",
        [LID.RN_CONFIG_REWORK + 1]                = "In preparazione per Midnight e le costanti modifiche di configurazione richieste durante l'apprendimento di nuovi alberi delle professioni, l'interfaccia utente è stata aggiornata per rendere più facile vedere quali oggetti hanno la scansione abilitata.",
        [LID.RN_CONFIG_REWORK + 2]                = "La configurazione della professione e del saluto è stata spostata nel proprio pannello. Dopo aver aperto una professione una volta, qualsiasi personaggio può configurarla dal nuovo menu.",
        [LID.RN_CONFIG_REWORK + 3]                = "La scansione degli oggetti ora ha quattro stati: in attesa di revisione, attiva, disattiva e non appresa. Man mano che le ricette vengono apprese, passano in attesa di revisione, rendendo facile tracciare ciò che potresti voler abilitare.",
        [LID.RN_CONFIG_REWORK + 4]                = "Questo nuovo pannello è accessibile tramite il pulsante 'Config' nella parte superiore di 'Ordini Chat', o il solito pulsante 'Mostra CraftScan' nella finestra della professione.",
        [LID.RN_SUBSTITUTION_TAGS]                = "Tag di Sostituzione",
        [LID.RN_SUBSTITUTION_TAGS + 1]            = "I tag di sostituzione possono ora essere utilizzati nei saluti e nelle parole chiave in tutta l'interfaccia utente.",
        [LID.RN_SUBSTITUTION_TAGS + 2]            = "I tag sono destinati a supportare l'aggiornamento rapido dei contenuti stagionali ed evitare duplicazioni.",
        [LID.RN_SUBSTITUTION_TAGS + 3]            = "I livelli degli oggetti stagionali sono spesso inclusi nelle parole chiave secondarie. Le parole chiave secondarie ora si completano con tabulazione ai tag 'Epic', 'Rare' e 'pvp', che possono essere utilizzati per impostare i livelli degli oggetti in un unico posto per aggiornamenti facili.",
        [LID.RN_SUBSTITUTION_TAGS + 4]            = "Le abbreviazioni comuni per gli oggetti sono spesso incluse nelle parole chiave degli oggetti. Queste possono ora essere condivise tra professioni e rarità in modo da dover impostare ogni slot solo una volta. Le parole chiave degli oggetti ora si completano con tabulazione a un tag slot oggetto.",
        [LID.RN_SUBSTITUTION_TAGS + 5]            = "I saluti supportano anche i tag, quindi puoi facilmente categorizzare e aggiornare le commissioni mentre la concorrenza si connette e disconnette.",
        [LID.RN_SUBSTITUTION_TAGS + 6]            = "Con l'introduzione dei tag, il supporto per la configurazione basata sulle categorie di professione integrate è stato rimosso. Ora puoi creare i tuoi raggruppamenti tramite tag invece.",
        [LID.RN_SUBSTITUTION_TAGS + 7]            = "I tag supportano un sistema di completamento automatico molto rudimentale. Le scelte appaiono mentre digiti e una volta che c'è una sola scelta possibile, finisce il tag per te. Se è troppo fastidioso, può essere disabilitato.",
        ["Concentration Dependent"]               = "Dipendente dalla Concentrazione",
        ["dialog.item.required_concentration"]    = "Concentrazione Richiesta",
        ["dialog.item.required_concentration.tooltip.body"] = "Scansiona condizionalmente questo oggetto in base alla concentrazione disponibile.\n\nL'esatta quantità di concentrazione richiesta dipende dal tuo albero delle professioni e dai materiali forniti. Usa la modalità simulazione in CraftSim per ottenere una buona stima.\n\nQuando impostato su un valore diverso da zero, questa ricetta verrà inserita in una sezione separata che indica che la scansione dipende dalla concentrazione.",
        ["dialog.item.required_concentration.tooltip.body.ready"] = "Concentrazione attuale: %d.\n\nScansione attiva.",
        ["dialog.item.required_concentration.tooltip.body.cooldown"] = "Concentrazione attuale: %d.\n\nLa scansione sarà abilitata tra %s.",
        ["dialog.pending_review_state"]           = "In attesa di revisione",
        ["dialog.pending_review_state.tooltip.body"] = "Sposta questa ricetta nella sezione in attesa di revisione.\n\nIn attesa di revisione è inteso come un'area di sosta in modo da poter tracciare facilmente le ricette che intendi abilitare una volta che hai abbastanza conoscenza per crearle al massimo rango.",
        ["Open in CraftScan"]                     = "Allega CraftScan",
        ["dialog.enable_all"]                     = "Abilita tutto",
        ["dialog.enable_all.tooltip.body"]        = "Abilita la scansione per tutte le ricette che sono attualmente in attesa di revisione. Le ricette non apprese non verranno abilitate automaticamente quando vengono apprese.",
        ["Not supported"]                         = "Non scansionabile",
        ["decor"]                                 = "Decorazione",
        ["Loading..."]                            = "Caricamento...",
        ["Hide CraftScan"]                        = "Stacca CraftScan",
    }
end
